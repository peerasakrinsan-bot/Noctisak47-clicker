...
function _cacheEls() {
  ['hpFill','godFill','koNum','scoreNum','coinNum',
   'bossBar',
   'godLevelWrap','godLevelNum','godLevelName','godTimer2','odLevelBadge',
