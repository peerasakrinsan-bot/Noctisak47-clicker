...
| bh | BAPHOBET | money/special | **SOUL CONTRACT** (3 identities only): AK47 no-cooldown frenzy; every AK47 BOMB → **BLOOD MONEY** (Zeny × chain `4 + chain×1.5`, cap 30k; chain resets on WP miss) | **💀 DEVIL TAX**: hidden pity (`bloodNorm²`, owed-Zeny / `80k+KO×4k`) → cinematic theft of **40–60% run Zeny** | cs_baphomet | break, sinmax |
